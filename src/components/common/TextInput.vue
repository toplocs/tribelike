<template>
  <div
    class="relative w-full flex items-center min-w-[10rem] outline-none rounded-md transition duration-100 border bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-900 dark:text-white border-gray-300 dark:border-gray-600"
  >
    <input
      :id="id"
      :type="type"
