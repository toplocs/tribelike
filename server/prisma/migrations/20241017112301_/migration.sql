...
-- AddForeignKey
ALTER TABLE "Wiki" ADD CONSTRAINT "Wiki_locationId_fkey" FOREIGN KEY ("locationId") REFERENCES "Location"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_WikiInterests" ADD CONSTRAINT "_WikiInterests_A_fkey" FOREIGN KEY ("A") REFERENCES "Interest"("id") ON DELETE CASCADE ON UPDATE CASCADE;
